...
class Feeder(Dataset):
    def __init__(self, data_path, label_path,
                 ...
                 window_size=-1, normalization=False, debug=False, use_mmap=True, random_mirror=False, random_mirror_p=0.5, is_vector=False, fold=0, max_length=40):
        """
        ...
        self.labels_dict = {'outside left': 0, 'starting': 1, 'early': 1, 'middle': 2, 'full': 2, 'outside right': 0, 'ending': 3, 'late': 3, 'outside': 0}
    ...
    def load_data(self):
        ...
        if self.debug:
            ...
            # self.pair_speaker_referent = [self.pair_speaker_referent[i] for i in idx] <--- Ilya commented this
    ...
    def __getitem__(self, index):
        ...
        labels_dict = {'label': labels, 'actual_label': actual_label, 'speaker': speaker, 'referent': referent, 'start_frame': int(start_frame), 'end_frame': int(end_frame), 'keypoints': data_numpy, 'fold': self.fold}
