...
class Feeder(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if label == 'iconic' or label == 'gesture':
            label = 1
        else:
            label = 0
        ...
        speaker_referent = self.pair_speaker_referent[index]
        name_frame = self.sample_name[index]
        # make a dictionary to store the data
        labels_dict = {'label': label, 'actual_label': actual_label, 'speaker_referent': speaker_referent, 'name_frame': name_frame}
